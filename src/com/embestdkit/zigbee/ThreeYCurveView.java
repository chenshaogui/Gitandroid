 ...
 * 
 */
public class ThreeYCurveView extends View {
	static String TAG = "HumidityCurveView";

	public ThreeYCurveView(Context context) {
		super(context);

	}

	public ThreeYCurveView(Context c, AttributeSet attr) {
		super(c, attr);
	 ...
	 * @param style
	 */
	public ThreeYCurveView(Context c, AttributeSet attr, int style) {
		super(c, attr, style);
	}
	...
	void drawCross(Canvas canvas) {
		...
		canvas.drawText("当前Y值", spaceWidth + textw / 2, sh + ph / 2 - 20, paint);
		if (mDataCnt > 0) {
