...
public class ZbLink implements Runnable {
	...
	private static final int CONNECT_DISCONNECT = 0; // 已关闭
	private static final int CONNECT_CONNECTING = 1; // 正在连接
	private static final int CONNECT_CONNECTED = 2; // 已连接
	private static final int CONNECT_CONNECTCLOSEING = 3; // 正在关闭
